...
public class VenteDAO {
   ...
   public static ArrayList<Cheval>  getLesChevaux(Connection connection, String idVente){      
    ...
    public static Cheval  getInfosCheval(Connection connection, String idCheval){      
        ...
        {
              unCheval = new Cheval();
            requete=connection.prepareStatement("SELECT cheval.id, cheval.nom, cheval.prixDepart, cheval.id_client as vendeur, cpere.nom as nomPere, cmere.nom as nomMere, typecheval.libelle as race, client.nom as nomVendeur, entraineur.nom as nomEntraineur from cheval, cheval cpere, cheval cmere, typecheval, client, entraineur where cheval.id_client = client.id and cheval.id_typeCheval = typecheval.id and cheval.idEntraineur = Entraineur.id and cheval.id_pere = cpere.id and cheval.id_mere = cmere.id and cheval.id = ?");
            ...
            rs=requete.executeQuery();
                ...
                Cheval ChevalM = new Cheval ();
                ChevalM.setNom(rs.getString("nomMere"));
                
                Cheval ChevalP = new Cheval ();
                ChevalP.setNom(rs.getString("nomPere"));
                ...
                unCheval.setMere(ChevalP);
                unCheval.setPere(ChevalM);
