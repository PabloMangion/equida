 ...
 */
public class ServletCategVente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(url.equals("/EquidaWeb20/ServletCategVente/categAjouter"))
        {  
            getServletContext().getRequestDispatcher("/vues/categAjouter.jsp").forward(request, response);
        }    
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (form.getErreurs().isEmpty()){
            ...
            CategVenteDAO.categAjouter(connection, uneCategVente);
            this.getServletContext().getRequestDispatcher("/vues/categConsulter.jsp" ).forward( request, response );
        }
        else
        { 
